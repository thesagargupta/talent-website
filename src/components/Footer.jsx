        ...
        <div className="footer-content">
          ...
          <a href="/" className="logo-link">
            ...
            <p className="footer-description">
              Connecting talented individuals with those who need their skills. 
              Discover, learn, and grow with our community of passionate experts.
            </p>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/browse-talents" className="footer-link">Browse Talents</Link></li>
              <li><Link to="/list-talent" className="footer-link">List Your Talent</Link></li>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li><a href="#" className="footer-link">Cooking</a></li>
              <li><a href="#" className="footer-link">Teaching</a></li>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <div className="footer-copyright">
              <p>&copy; {currentYear} TalentHub. All rights reserved.</p>
            </div>
